      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center reveal-up">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-white/10 hover:bg-white/20 border border-white/25 text-white font-bold text-sm sm:text-base px-7 py-4 rounded-xl backdrop-blur-md transition-all duration-200 hover:-translate-y-0.5"
          >
